...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:kashibot\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=+55 85 99965-8678:5585999658678\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de bot. Registre-se para fazer amizade com o bot  por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar kashi|14\n\n──「 kashi BOT 」──`,
			...
			const adminbotnumber = ["5585999658678@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["556993733829@s.whatsapp.net"]//ubah nomor lo
			const premium = ["+1 (513) 647-8596@s.whatsapp.net","15136478596@s.whatsapp.net","+55 11 98613-7833@s.whatsapp.net","5511986137833@s.whatsapp.net","5585999658678@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO KASHI BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @kashi domina vida
          ...
          reply('Espere..')
			    ...
			    case 'dono':
                    ...
                    client.sendMessage(from, 'Meu dono é esse gasoso aí tal de "kashi"🙄, chama ele aí ele diz que é "Shitpost"',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT KASHI ✨* 」\n*│+ wa.me/5585999658678*╰──────*「 *KASHI* 」*────*\n\n*_SE QUER SER ADMIN DO BOT KASHI_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do kashi:*\n\n num tem laksksks})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
