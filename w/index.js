		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIOS DO BOT*',
			...
			const premium = ["15136478596@s.whatsapp.net","5511986137833@s.whatsapp.net","553798558301@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUARIO KASHI BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @kashi domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADM KASHI ✨* 」\n*│+ wa.me/15136478596*╰──────*「 *KASHI* 」*────*\n\n*_SE QUER SER ADMIN DO BOT _*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
